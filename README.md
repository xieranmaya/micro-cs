...
大喵教育是我从 2016 年 9 月开始做的前端培训，目前已经三年有余，此间我持续打造高品质的教学，励志为行业培养优秀的软件工程师。
...
第四期、第五期更是有10%以上的同学拿到了阿里巴巴外包的 offer（相当于阿里P5级别），另有一名同学进入了腾讯，往期也有同学进入小米、美团、百度、大搜车、蘑菇街等公司。
...
* 如何报名，何时开课？
    * 目前正在进行的是第六期，已于2019年4月30号开课
    * 第七期预计2019年11月中旬开课，将在9月底间开始报名，报名将会在我的QQ群(583477263)里进行通知，进群并关注群消息即可，如果错过了群里的通知，也可以直接向我询问
...
* 学费支持哪些支付方式？是否支持分期？
    ...
    * 学费的收取支持以下两种方式：
         * 一种是在大约开课三周后全款付学费，之前除报名费外不收取任何费用
         * 另一种是在收学费时先交一半学费，剩余的在课程结束前分月付清，同时会收取少量利息（日息万分之二，总利息120元）
    * 支持随时退学，学费按天成比例退还
* 是否需要提前预习？
    * 如果有时间和条件，最好提前开始自学
    * 可以自学的内容包括但不限于：
